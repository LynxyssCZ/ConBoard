...
};window.ConBoard=window.ConBoard||{},ConBoard.Timer=function(){this.interval=500,this.listeners=[]},ConBoard.Timer.prototype.Start=function(){this.interval=window.setInterval(this.Tick.bind(this),this.interval)},ConBoard.Timer.prototype.Tick=function(){var t=Date.now(),i=new Date(t),n={tick:t,day:i.getDay(),hours:i.getHours(),minutes:i.getMinutes()};for(var o in this.listeners){var e=this.listeners[o].fn,r=this.listeners[o].scope||window;e.call(r,n)}},ConBoard.Timer.prototype.on=function(t,i){this.listeners.push({fn:t,scope:i})},ConBoard.Timer.prototype.off=function(t,i){for(var n in this.listeners){var o=listeners[n];if(o.fn===t&&i===o.scope)return listeners.splice(n,1),void 0}},ConBoard.Timer.prototype.Stop=function(){window.clearInterval(this.interval)};window.ConBoard = window.ConBoard || {};
ConBoard.Board = function(boardDiv) {
	this.cats = [];
	this.container = boardDiv;
	this.container.style.width = document.body.clientWidth;
